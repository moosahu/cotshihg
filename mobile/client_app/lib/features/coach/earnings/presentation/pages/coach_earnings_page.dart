...
class CoachEarningsPage extends StatelessWidget {
            ...
            child: const Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    _Stat(label: 'هذا الشهر', value: '3,200 ر.س'),
                    _Stat(label: 'هذا الأسبوع', value: '850 ر.س'),
                    _Stat(label: 'اليوم', value: '150 ر.س'),
                  ],
                ),
              ],
            ),

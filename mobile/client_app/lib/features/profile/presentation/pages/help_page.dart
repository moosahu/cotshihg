...
class HelpPage extends StatelessWidget {
  ...
  static const _faqs = [
    (
      ...
      a: 'من الصفحة الرئيسية اختر الكوتش المناسب، ثم اضغط "احجز جلسة"، اختر الوقت المناسب، ثم أكمل الدفع.',
    ),
    // TODO: جلسة فورية — معطلة مؤقتاً، أعد تفعيل هذا السؤال عند الحاجة
    // (
    ...
    (
      q: 'كيف أنضم للجلسة؟',
      a: 'عند حلول موعد الجلسة، اذهب لـ "جلساتي" في حسابي واضغط "ابدأ الجلسة". الجلسة تبدأ بالصوت، ويمكنك تشغيل الكاميرا متى شئت.',
    ),
    (

      ...
      body: ListView(
        ...
        children: const [
          ...
          _Section(
            ...
            body:
                'جميع محادثاتك مع الكوتشيز تبقى سرية. لا يتم الاطلاع عليها إلا بموافقتك أو بموجب أمر قانوني.',
          ),
          _Section(
            title: 'حظر التسجيل والتصوير',
            body:
                'يُحظر تسجيل أو تصوير الجلسات والمحادثات بأي وسيلة كانت. بدخولك الجلسة فأنت توافق على هذا الشرط، وأي مخالفة تعرّض صاحبها للمساءلة القانونية وإيقاف الحساب فوراً.',
          ),
          _Section(
            title: 'الأمان',
            body:

        ...
        itemBuilder: (_, dayIndex) {
          ...
          return Card(
            ...
            child: ExpansionTile(
              ...
              subtitle: Text(hasSlots ? '${_schedule[dayIndex]!.length} فترة متاحة' : 'غير متاح', style: TextStyle(color: hasSlots ? AppTheme.successColor : AppTheme.textSecondary, fontSize: 12)),
              children: [
                Padding(
                        ...
                        ..._schedule[dayIndex]!.map((slot) => Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Spacer(),
                              IconButton(icon: const Icon(Icons.delete_outline, color: AppTheme.errorColor, size: 20), onPressed: () => setState(() => _schedule[dayIndex]!.remove(slot)), padding: EdgeInsets.zero, constraints: const BoxConstraints()),
                            ],
                          ),
                        )),
                      OutlinedButton.icon(

...
class _AvailabilityPageState extends State<AvailabilityPage> {
  ...
  Future<void> _addSlot(int dayIndex) async {
    TimeOfDay? start = await showTimePicker(
        context: context, initialTime: const TimeOfDay(hour: 9, minute: 0), helpText: 'وقت البداية');
    ...
    setState(() => _schedule.putIfAbsent(dayIndex, () => []).add({'start': startStr, 'end': endStr}));
  }
                ...
                return Card(
                  ...
                  child: ExpansionTile(
                    leading: Container(
                      ...
                      child: Center(
                        child: Text('${dayIndex + 1}',
                            style: TextStyle(
                                color: hasSlots ? Colors.white : AppTheme.textSecondary,
                    ...
                    subtitle: Text(
                      ...
                      style: TextStyle(
                          color: hasSlots ? AppTheme.successColor : AppTheme.textSecondary,
                          fontSize: 12),
                    ),
                    children: [
                      Padding(
